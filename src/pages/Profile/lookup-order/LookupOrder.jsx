export default function LookupOrder() {
	return (
		<div>
			...
			<div className="border-2 flex justify-between rounded">
				<input
					type="text"
					className="p-2 max-w-[300px] w-full outline-none caret-black font-semibold"
			...
			<div className="p-2">
				<div className="text-center p-4">
					...
					<a className="bg-blue-400 p-2 rounded text-white font-semibold inline-block">
						Tiếp tục mua hàng
					</a>
				</div>
				<div className="text-center block p-4">
					<p className="font-semibold pl-2 py-5 text-center">
						Vui lòng nhập mã đơn hàng của bạn để tra cứu!
					</p>
				</div>
				<div className="hidden max-w-[500px] shadow mx-auto p-4 rounded-xl">
					...
					<p>
						<span className="text-[1rem] font-semibold">Phương thức thanh toán :</span>
					</p>
					<p>
